            ...
            <div class="col-sm-10">
                <form class="form-horizontal" enctype="multipart/form-data" role="form" method="post">
                    ...
                    <div class='form-group <?= form_error('infraction_categoryID') ? "has-error" : ""?>' >
                        ...
                        <div class="col-sm-6">
                            ...
                            <?php
                                ...
                                echo form_dropdown("infraction_categoryID", $array, set_value("infraction_categoryID", $infraction->infraction_categoryID), "id='infraction_categoryID' class='form-control select2'");
                            ?>
                        </div>
                    ...
                    <div class='form-group <?= form_error('infraction_category_codeID') ? "has-error" : ""?>' >
                        ...
                        <div class="col-sm-6">
                            ...
                            <?php
                                ...
                                foreach ($infraction_category_codes as $code) {
                                    $array[$code->infraction_category_codeID] = $code->infraction_category_code;
                                }
                                echo form_dropdown("infraction_category_codeID", $array, set_value("infraction_category_codeID", $infraction->infraction_category_codeID), "id='infraction_category_codeID' class='form-control select2'");
                            ?>
                        </div>
                        <span class="col-sm-4 control-label">
                    ...
                    <div class='form-group <?= form_error('infraction_created_at') ? "has-error" : ""?>' >
                        ...
                        <div class="col-sm-6">
                            <input type="text" class="form-control" id="infraction_created_at" name="infraction_created_at" value="<?=set_value('infraction_created_at', date('d-m-Y'), strtotime($infraction->infraction_created_at))?>" >
                        </div>
                        <span class="col-sm-4 control-label">
                    ...
                    <div class='form-group <?= form_error('classesID') ? "has-error" : ""?>' >
                        ...
                        <div class="col-sm-6">
                            ...
                            <?php
                                ...
                                echo form_dropdown("classesID", $array, set_value("classesID", $infraction->classesID), "id='classesID' class='form-control select2'");
                            ?>
                        </div>
                        <span class="col-sm-4 control-label">
                    ...
                    <div class='form-group <?= form_error('studentID') ? "has-error" : ""?>' >
                        ...
                        <div class="col-sm-6">
                            <?php
                                ...
                                echo form_dropdown("studentID", $array, set_value("studentID", $infraction->studentID), "id='studentID' class='form-control select2'");
                            ?>
                        </div>
                    ...
                    <div class="form-group">
                        <div class="col-sm-offset-2 col-sm-8">
                            <input type="submit" class="btn btn-success" value="<?=$this->lang->line("update_infraction")?>" >
                        </div>
                    </div>
