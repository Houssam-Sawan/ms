                    ...
                    <table id="example1" class="table table-striped table-bordered table-hover dataTable no-footer">
                        ...
                        <thead>
                            ...
                            <tr>
                                ...
                                <th class="col-sm-3"><?=$this->lang->line('transport_driver')?></th>

                                <th class="col-sm-3"><?=$this->lang->line('transport_phone')?></th>                                
                            ...
                            <?php if(count($transports)) {$i = 1; foreach($transports as $transport) { ?>
                                ...
                                <tr>
                                    ...
                                    <td data-title="<?=$this->lang->line('transport_driver')?>">
                                        ...
                                        <?php echo $transport->driver; ?>

                                    </td>

                                    <td data-title="<?=$this->lang->line('transport_phone')?>">
