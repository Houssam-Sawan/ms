                ...
                <form class="form-horizontal" role="form" method="post" enctype="multipart/form-data">
                    ...
                    ?>
                        <label for="auto_invoice_generate" class="col-sm-2 control-label">
                            ...
                            <i class="fa fa-question-circle" data-toggle="tooltip" data-placement="top" title="Enable/Disable library fee, hostel fee, transport fee invoice in student account automatically. it's add monthly wise."></i>
                        </label>
...
function checkedStatus(checkedStatus = "<?=$setting->captcha_status?>") {
    console.log(checkedStatus == false);
