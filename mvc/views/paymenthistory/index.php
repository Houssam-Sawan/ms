                    ...
                    <table id="example1" class="table table-striped table-bordered table-hover dataTable no-footer">
                        ...
                        <thead>
                            ...
                            <tr>
                                ...
                                <th style="max-width:200px;white-space:normal;"><?=$this->lang->line('paymenthistory_feetype')?></th>
                        ...
                        <tbody>
                            ...
                            <?php if(count($payments)) {$i = 1; foreach($payments as $payment) { ?>
                                ...
                                <tr>
                                    ...
                                    <td style="max-width:200px;white-space:normal;" data-title="<?=$this->lang->line('paymenthistory_feetype')?>">
