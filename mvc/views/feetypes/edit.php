                ...
                <form class="form-horizontal" role="form" method="post">
                   ...
                   <?php 
                    ...
                    ?>
                        ...
                        <label for="feeamount" class="col-sm-2 control-label">
                        ...
                        <div class="col-sm-6">
                            ...
                            <input type="number" class="form-control" id="feeamount" name="feeamount" value="<?=set_value('feeamount', $feetypes->feeamount)?>" >

                        </div>

                        <span class="col-sm-4 control-label">

                            <?php echo form_error('feeamount'); ?>
