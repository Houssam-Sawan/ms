            ...
            <div class="col-sm-12">
                ...
                <div id="hide-table">
                    <table class="table table-striped table-bordered table-hover dataTable no-footer">
                        <thead>
                            <tr>
                                <th class="col-sm-1" style='background-color:#0E87C9;color:#fff;'><?=$this->lang->line('slno')?></th>
                                <th class="col-sm-1" style='background-color:#0E87C9;color:#fff;'><?=$this->lang->line('mark_photo')?></th>
                                <th class="col-sm-2" style='background-color:#0E87C9;color:#fff;'><?=$this->lang->line('mark_name')?></th>
                                <?php
                                    foreach ($markpercentages as $data) {
                                        echo "<th class='col-sm-2' style='background-color:#0E87C9;color:#fff;' >$data->markpercentagetype <br/>( $data->percentage % )</th>";
                                    }
                                ?>
                                </th>
                            </tr>
                                    ...
                                    <?php
                                        foreach ($markpercentages as $data) {
                                            ...
                                            echo "<td data-title='$data->markpercentagetype'>";
                                                echo "<input style= 'text-align: center;color: #cc0000;font-weight: bold; width: 66px; height: 30px;' class='form-control mark' type='' name='mark-$data->markpercentageID-$student->studentID' value='".$markRelations[$student->studentID][$data->markpercentageID]."' />";
                                            echo "</td>";
                                        }
                                    ?>
