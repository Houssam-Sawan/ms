                ...
                <form class="form-horizontal" role="form" method="post">
                    ...
                    ?>
                        <label for="capacity" class="col-sm-2 control-label">
                            <?=$this->lang->line("section_capacity")?>
                        </label>
                        <div class="col-sm-6">
                    ...
                    ?>
                        <label for="classesID" class="col-sm-2 control-label">
                            <?php
                                if($siteinfos->school_type == 'classbase') {
                                    echo $this->lang->line("section_classes");
                                    $array = array();
                        ...
                        <div class="col-sm-6">
                            <?php
                                ...
                                echo form_dropdown("classesID", $array, set_value("classesID", $section->classesID), "id='classesID' class='form-control select2'");
                            ?>
                        </div>
                        <span class="col-sm-4 control-label">
