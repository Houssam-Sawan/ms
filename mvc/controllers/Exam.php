...
*/
	...
	protected function rules() {
		$rules = array(
            ...
            array(
				'field' => 'percentage',
				'label' => $this->lang->line("exam_percentage"),
				'rules' => 'trim|required|xss_clean|max_length[3]|numeric'
			),
			array(
				'field' => 'note', 
	...
	public function add() {
		...
		if($_POST) {
			...
			if ($this->form_validation->run() == FALSE) {
				...
				if($this->ecode($this->data['siteinfos']->purchase_code, $this->data['siteinfos']->purchase_username, config_item('ini_version')) == FALSE) {
