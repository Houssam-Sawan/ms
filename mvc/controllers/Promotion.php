...
*/
	...
	public function summary() {
		...
		$settingMarkPercentages = $this->get_setting_mark_percentage();

		foreach ($settingMarkPercentages as $key => $settingMarkPercentage) {
			if(!in_array($settingMarkPercentage->markpercentageID, $this->data['promotionMarkPercentages'])) {
				unset($settingMarkPercentages[$key]);
			}
		}
		$this->data['markpercentages'] = $settingMarkPercentages;
	...
	public function pcode_validation($pcode, $pusername, $version) {
