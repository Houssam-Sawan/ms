...
*/
	...
	function getMark($studentID, $classesID, $pdf=FALSE) {
		...
		if((int)$studentID && (int)$classID) {
            ...
            if($this->data["student"] && $this->data["classes"]) {
                ...
                $this->data['academic_year'] = $this->schoolyear_m->get_schoolyear($this->data["student"]->schoolyearID);

                $this->data['set'] 				= $classID;

                $this->data["infractions"]            = $this->infraction_m->join_get_infraction_by_student($studentID, $schoolyearID);
	...
	function getFinalMark($studentID, $classesID, $pdf=FALSE) {
		...
		if((int)$studentID && (int)$classID) {
            ...
            if($this->data["student"] && $this->data["classes"]) {
				...
				$this->data["section"] = $this->section_m->get_section($this->data['student']->sectionID);
				$this->data["teacher"] = $this->teacher_m->get_teacher($classID);

				if($pdf == TRUE) {

					$this->printview($this->data, 'mark/final_print_preview');
	...
	function getSingleMark($examID, $studentID, $classesID, $pdf=FALSE) {
		...
		if((int)$studentID && (int)$classID) {
            ...
            if($this->data["student"] && $this->data["classes"]) {
				...
				$this->data["exams"] 			= $this->exam_m->get_order_by_exam(array("examID" => $examID));
				...
				if($pdf == TRUE) {
					...
					$this->printview($this->data, 'mark/print_preview_single');
					...
					if($originalStudent) {
						...
						if($this->data['student']) {
							...
							if($originalStudent->classesID == $this->data['student']->classesID) {
								...
								$this->getFinalMark($studentID, $classID, TRUE);
					...
					if($originalStudent) {
						...
						if($this->data['student']) {
							...
							if($originalStudent->classesID == $this->data['student']->classesID) {
                                ...
                                $this->getSingleMark($examID, $studentID, $classID, TRUE);
