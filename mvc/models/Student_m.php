...
class student_m extends MY_Model {
	...
	function get_max_roll($roll, $classesID, $sectionID) {

		$query = $this->db->query("SELECT MAX(roll) AS maxroll FROM student WHERE roll LIKE '%$roll%' AND classesID= '$classesID' AND sectionID='$sectionID'");
